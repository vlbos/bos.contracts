...
class [[eosio::contract("bos.bridge")]] bos_bridge : public eosio::contract {
 ...
 public:
   ...
   void check_data(const std::string& data, const std::string& data_name) {
      ...
      uint16_t data_size = unpack<bridge_parameters>(_bridge_meta_parameters.parameters_data).max_data_size;
   ...
   /**
    * @brief  Registers bridge service information
    */
    ...
    */
   [[eosio::action]] void bridgepush(uint64_t service_id, uint64_t cycle_number, uint64_t request_id, string data, name contract_account);
   ...
   /**
    * @brief   Performs bridge service special action
    */
   [[eosio::action]] void execaction(uint64_t service_id, uint8_t action_type);

   /**
    * @brief  Unregister bridge service by provider
    */
   ...
   /**
    * @brief  Clears data when bridge data's accessable time is timeout
    */
   ...
   using bridgepush_action = eosio::action_wrapper<"bridgepush"_n, &bos_bridge::bridgepush>;
   using claim_action = eosio::action_wrapper<"claim"_n, &bos_bridge::claim>;
   using execaction_action = eosio::action_wrapper<"execaction"_n, &bos_bridge::execaction>;
   using unregister_action = eosio::action_wrapper<"unregservice"_n, &bos_bridge::unregservice>;
   using starttimer_action = eosio::action_wrapper<"starttimer"_n, &bos_bridge::starttimer>;
   using cleardata_action = eosio::action_wrapper<"cleardata"_n, &bos_bridge::cleardata>;
   using setparameter_action = eosio::action_wrapper<"setparameter"_n, &bos_bridge::setparameter>;
   ...
   /**
    * @brief   Subscribes bridge service by consumer
    */
   ...
   using subscribe_action = eosio::action_wrapper<"subscribe"_n, &bos_bridge::subscribe>;
   using requestdata_action = eosio::action_wrapper<"requestdata"_n, &bos_bridge::requestdata>;
   ...
   /**
    * @brief  Deposits core tokens to bridge risk control fund
    */
 ...
 private:
   ...
   void bridge_transfer(name from, name to, asset quantity, string memo, bool is_deferred);
