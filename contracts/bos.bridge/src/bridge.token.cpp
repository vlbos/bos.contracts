...
void bos_bridge::create( name   issuer,
...
void bos_bridge::issue( name to, asset quantity, string memo )
{
...
void bos_bridge::retire( asset quantity, string memo )
{
    auto sym = quantity.symbol;
    check( sym.is_valid(), "invalid symbol name" );
    check( memo.size() <= 256, "memo has more than 256 bytes" );
...
void bos_bridge::transfer( name    from,
                      name    to,
                      asset   quantity,
                      string  memo )
{
...
void bos_bridge::sub_balance( name owner, asset value ) {
...
void bos_bridge::add_balance( name owner, asset value, name ram_payer )
{
...
void bos_bridge::open( name owner, const symbol& symbol, name ram_payer )
{
...
void bos_bridge::close( name owner, const symbol& symbol )
{
   require_auth( owner );
   accounts acnts( _self, owner.value );
...
///bos begin
void bos_bridge::addblacklist(const std::vector<name>& accounts)
{
   require_auth(_self);
...
void bos_bridge::rmblacklist(const std::vector<name>& accounts)
{
   require_auth(_self);
