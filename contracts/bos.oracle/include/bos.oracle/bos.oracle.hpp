...
#include "bos.oracle/tables/bos.oracle.hpp"
#include "bos.oracle/tables/bos.oraclize.hpp"
...
class [[eosio::contract("bos.oracle")]] bos_oracle : public eosio::contract {
 ...
 using contract::contract;
  bos_oracle(name receiver, name code, datastream<const char*> ds ) : contract( receiver,  code, ds ), requests(_self, _self.value), token("boracletoken"_n), oraclizes_table(_self, _self.value) {}
