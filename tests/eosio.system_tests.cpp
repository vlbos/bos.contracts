...
///bos begin=====================================
/// bos namelist
BOOST_FIXTURE_TEST_CASE( namelist_insert, eosio_system_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
   ...
   auto active_cfg2 = control->get_global_properties().cfg2;
...
BOOST_FIXTURE_TEST_CASE( namelist_remove, eosio_system_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
